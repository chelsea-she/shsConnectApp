...
//  schoolApp1
//
//  Created by Matthias Park 2025 on 6/2/23.
//
...
final class StorageManager {
    ...
    public func uploadProfilePicture(with data: Data, fileName: String, completion: @escaping UploadCompletion) {
        storage.child("profile_pictures/\(fileName)").putData(data, metadata: nil, completion: { [weak self] metadata, error in
            ...
            strongSelf.storage.child("profile_pictures/\(fileName)").downloadURL(completion: { url, error in
